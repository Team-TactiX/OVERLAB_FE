...
const FeedEdit = ({ post, onUpdate, onClose }) => {
  ...
  const [teamId, setTeamId] = useState(post.teamId);
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen bg-black bg-opacity-50 flex justify-center items-center z-40">
      <div
        ...
        className="bg-white rounded-lg p-8 w-full max-w-md box-border shadow-lg relative"
      >
        ...
        <textarea
          ...
          className="w-full mb-[2vh] p-2 border"
        />
        <textarea
          value={content}
          onChange={(e) => setContent(e.target.value)}
          className="w-full h-[10vh] p-2 border"
        />
        <div className="mb-[3vh]">
          <div className="text-[1.7vh] font-semibold mb-[1vh]">
        ...
        <button
          onClick={handleEdit}
          className="w-full mt-[2vh] p-2 bg-green-500 text-white"
        >
          수정
        </button>
      </div>
