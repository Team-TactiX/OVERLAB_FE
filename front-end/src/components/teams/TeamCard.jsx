  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-[1.5vh]">
        ...
        />
        <div>
          <div className="text-[1.7vh] font-bold mb-[0.3vh]">
            {team.teamName}
          </div>
          <div className="text-[1.5vh] text-gray-500 mb-[0.3vh]">
            {team.location} · {team.users.length}명
          </div>
          <div className="flex gap-[0.5vh] flex-wrap">
            {isRecruiting('팀원 모집') && (
              <span className="text-[1.2vh] border border-gray-400 text-gray-700 px-[0.8vh] py-[0.3vh] rounded-full">
                팀원 모집 중{' '}
              </span>
            )}
            {isRecruiting('용병') && (
