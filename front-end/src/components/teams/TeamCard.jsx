...
const TeamCard = ({ team }) => {
  return (
    <Link
  to={`/team/${team.teamId}`}
  className="flex flex-col items-center justify-between bg-white rounded-[1.2vh] shadow-md cursor-pointer transition hover:scale-[1.02] hover:shadow-lg aspect-square p-[1.5vh]"
>
